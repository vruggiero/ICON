...
static struct vsop87_terms l1[64] = { { 1.753470456730000e+00, 0.00000000000e+00, 0.000000000000000e+00 },
...
static struct vsop87_terms l2[34] = { { 6.283319667474910e+03, 0.00000000000e+00, 0.000000000000000e+00 },
...
static struct vsop87_terms l3[20] = { { 5.291887000000000e-04, 0.00000000000e+00, 0.000000000000000e+00 },
...
static struct vsop87_terms l4[7] = { { 2.892260000000000e-06, 5.84384198723e+00, 6.283075849991400e+03 },
...
static struct vsop87_terms l5[3] = { { 1.140840000000000e-06, 3.14159265359e+00, 0.000000000000000e+00 },
...
static struct vsop87_terms l6[1] = { { 8.780000000000000e-09, 3.14159265359e+00, 0.000000000000000e+00 } };

static struct vsop87_terms b1[5] = { { 2.796200000000000e-06, 3.19870156017e+00, 8.433466158130829e+04 },
...
static struct vsop87_terms b2[2] = { { 9.029999999999999e-08, 3.89729061890e+00, 5.507553238667400e+03 },
                                     { 6.177000000000000e-08, 1.73038850355e+00, 5.223693919802200e+03 } };

static struct vsop87_terms r1[40] = { { 1.000139887990000e+00, 0.00000000000e+00, 0.000000000000000e+00 },
...
static struct vsop87_terms r2[10] = { { 1.030186080000000e-03, 1.10748969588e+00, 6.283075849991400e+03 },
...
static struct vsop87_terms r3[6] = { { 4.359385000000000e-05, 5.78455133738e+00, 6.283075849991400e+03 },
...
static struct vsop87_terms r4[2] = { { 1.445950000000000e-06, 4.27319435148e+00, 6.283075849991400e+03 },
                                     { 6.729000000000000e-08, 3.91697608662e+00, 1.256615169998280e+04 } };

static struct vsop87_terms r5[1] = { { 3.858000000000000e-08, 2.56384387339e+00, 6.283075849991400e+03 } };

static double
sum_vsop87(double t, struct vsop87_terms *term, int ubound_term, int order)
{
  double td10, tn, sum;
  int k;
 ...
 */
void
earth_position(double t, double *l, double *b, double *r)
{
  double ld;
