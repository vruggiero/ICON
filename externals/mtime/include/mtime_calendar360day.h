...
struct _datetime *getDate360FromJulian(struct _julianday *jd, struct _datetime *gd);
struct _julianday *getJulianFromDate360(struct _datetime *gd, struct _julianday *jd);
