...
struct _datetime *getDateGregorianFromJulian(struct _julianday *jd, struct _datetime *gd);
struct _julianday *getJulianFromDateGregorian(struct _datetime *gd, struct _julianday *jd);
