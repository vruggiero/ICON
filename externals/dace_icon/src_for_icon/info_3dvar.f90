...
PUBLIC :: INFO_RevisionTag, INFO_CheckinDate
!
!==============================================================================
!
...
CHARACTER (LEN=*), PARAMETER :: INFO_LibraryName     = 'dace'
CHARACTER (LEN=*), PARAMETER :: INFO_RevisionTag     = 'V2_22'
CHARACTER (LEN=*), PARAMETER :: INFO_CheckinDate     = '2024-10-02 00:00:00'
CHARACTER (LEN=*), PARAMETER :: INFO_RevisionNumber  = ''
CHARACTER (LEN=*), PARAMETER :: INFO_CheckoutDate    = ''
...
!
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
!+ A.Rhodin: currently disabled as actual parameter Options may be not present
!+
...
!
END MODULE info_3dvar
!==============================================================================
block data info_3dvar_common_blockdata
  use info_3dvar
  implicit none
#include "info_3dvar.incf"
  data INFO_Tag  / INFO_RevisionTag /
  data INFO_Date / INFO_CheckinDate /
end block data
!==============================================================================
