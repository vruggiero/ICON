#!/bin/ksh -l
#
# convert_hd_discharge_to_ocean.ksh - Script to convert HD discharges onto and ocean grid
# 
...
#
# *** Script/programs converts discharge on the HD grid to a selected ocean grid. 
#     The HD mouths are directly converted to mouth points on the ocean grid.
#     Program requires a HD coupling file that, e.g. has been generated with generate_hd_coupling_file.ksh 
...
if [ "$YBEG" = "" ] ; then echo "First year is not set --> use default: 1979" ; YBEG=1979 ; fi
...
TAG_IN='gswp3_hpy_hd1_11'     # Tag for discharge data
TAG_OUT='icon_coast_kai'      # Tag for ocean model grid
DN_HDCOUPLE='/work/gg0302/g260122/HD/input/icon/hdcouple_hd_vs1_11_to_icon-coast_imode1.nc'
