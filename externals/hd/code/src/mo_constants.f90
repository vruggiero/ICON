! mo_constants.f90 - Basic constants and derived constants
!
! Copyright (C) 2014, MPI-M
! SPDX-License-Identifier: BSD-3-Clause
! See ./LICENSES/ for license information
!
! This files has been modified for the use in the HD model.
...
! Molar weights in g/mol
  REAL(dp), PARAMETER :: amco2 = 44.0095_dp       ! molecular weight of carbon dioxide
...
! Earth and earth orbit parameters
  REAL(dp), PARAMETER :: a     = 6371229.0_dp     ! radius of the earth in m, updated 23.5.2024.
