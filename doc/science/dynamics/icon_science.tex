...
\ifpdf
\parbox{2cm}{
\includegraphics[height=2cm]{mpilogo.pdf}
}
\hfill
\parbox{2cm}{
\includegraphics{dwdlogo.pdf}
}
\fi
\end{center}
...
\input{model_equations_ICONAM}

\input{terrain_following_ICONAM}

\input{vortex_bracket_ICONAM}

\input{specials_triangle_ICONAM}
